...
let MainJS = "CLodopfuncs.js",
    URL_WS1 = "ws://localhost:8080/" + MainJS,
    URL_WS2 = "ws://localhost:18000/" + MainJS,
    URL_HTTP1 = "ws://localhost:8080/" + MainJS,
    URL_HTTP2 = "ws://localhost:18000/" + MainJS,
    ...
    try {
        ...
        if (needCLodop() || isLinuxX86 || isLinuxARM) {
            ...
            if ((!LODOP) || (!LODOP.VERSION)) {
                Message.warning((isWinIE64 ? strLodop64Install : strLodopInstall) + strInstallOK);
                return LODOP;
            }
            if (LODOP.VERSION < "6.2.2.6") {
                Message.warning((isWinIE64 ? strLodop64Update : strLodopUpdate) + strInstallOK);
            }
        }
