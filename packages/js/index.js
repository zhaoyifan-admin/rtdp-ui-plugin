...
export function consoleLog(type = 'success', message = '无提示信息') {
    const TITLE = 'Tvue后台打印信息';
    const TIP_MESSAGE = '提示';
    const SVG_BASE64 = 'data:image/svg+xml;base64,';
    ...
    console.log(
        `%c %c ${TITLE} %c ${TIP_MESSAGE} %c \n %c ${message} `,
        `font-size: 16px;padding:4px;background: url(${SVG_BASE64}) 100% / contain no-repeat`,
        ...
        '',
        `font-size: 10px;font-style:italic;background: ${bgColor}; margin-left: 11px;margin-top: 5px;padding: 6px; border-radius: 3px; color: #fff`
    );
}
